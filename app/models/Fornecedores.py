...
class Fornecedores(Base):
    ...
    def __repr__(self) -> str:
        ...
        return f"Fornecedor(id={self.id}, razao_social={self.razao_social}, cnpj={self.cnpj}, endereco={self.endereco}, cep={self.cep}, email={self.email}, nome_responsavel={self.nome_responsavel}, id_empresa={self.id_empresa})"
